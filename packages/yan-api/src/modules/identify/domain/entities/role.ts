...
export class Role extends AggregateRoot<Id> {
    ...
    private readonly permissionIds: number [];

    constructor(id: Id, name: RoleName, description: RoleDescription, permissionIds: number []) {
        super();
        this.id = id;
        this.name = name;
    ...
    static create(name: string, description: string, permissionIds: number []): Role {
